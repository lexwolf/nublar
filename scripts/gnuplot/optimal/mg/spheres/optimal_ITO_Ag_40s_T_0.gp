...
set output '../../../../../img/optimal/mg/spheres/optimal_ITO_Ag_40s_T_0.png'
set title 'MG spheres fit ITO_Ag_40s_T_0: effe=0.95, d=7.627 nm, SSE=3.125'
...
plot \
  ...
  '../../../../../data/output/optimal/mg/spheres/optimal_ITO_Ag_40s_T_0.dat' using 1:3 with lines lw 2 title 'mg spheres best fit'
