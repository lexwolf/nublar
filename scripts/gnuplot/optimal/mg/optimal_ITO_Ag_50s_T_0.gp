...
set output '../../../../img/optimal/mg/optimal_ITO_Ag_50s_T_0.png'
set title 'MG fit ITO_Ag_50s_T_0: effe=0.83835, d=10 nm, SSE=0.002109'
...
plot \
  ...
  '../../../../data/output/optimal/mg/optimal_ITO_Ag_50s_T_0.dat' using 1:3 with lines lw 2 title 'mg best fit'
