...
set output '../../../../../img/optimal/mg/holes/optimal_ITO_Ag_50s_T_0.png'
set title 'MG holes fit ITO_Ag_50s_T_0: effe=0.16847, d=66.608 nm, SSE=0.14917'
...
plot \
  ...
  '../../../../../data/output/optimal/mg/holes/optimal_ITO_Ag_50s_T_0.dat' using 1:3 with lines lw 2 title 'mg holes best fit'
