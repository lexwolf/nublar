...
set output '../../../../../img/optimal/mg/holes/optimal_ITO_Ag_20s_T_0.png'
set title 'MG holes fit ITO_Ag_20s_T_0: effe=0.11265, d=87.333 nm, SSE=1.2078'
...
plot \
  ...
  '../../../../../data/output/optimal/mg/holes/optimal_ITO_Ag_20s_T_0.dat' using 1:3 with lines lw 2 title 'mg holes best fit'
