...
set output '../../../../../img/optimal/mg/holes/optimal_ITO_Ag_30s_T_0.png'
set title 'MG holes fit ITO_Ag_30s_T_0: effe=0.056824, d=76.27 nm, SSE=0.63023'
...
plot \
  ...
  '../../../../../data/output/optimal/mg/holes/optimal_ITO_Ag_30s_T_0.dat' using 1:3 with lines lw 2 title 'mg holes best fit'
