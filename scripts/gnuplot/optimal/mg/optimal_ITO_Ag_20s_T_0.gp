...
set output '../../../../img/optimal/mg/optimal_ITO_Ag_20s_T_0.png'
set title 'MG fit ITO_Ag_20s_T_0: effe=0.78253, d=8.7333 nm, SSE=0.0026051'
...
plot \
  ...
  '../../../../data/output/optimal/mg/optimal_ITO_Ag_20s_T_0.dat' using 1:3 with lines lw 2 title 'mg best fit'
