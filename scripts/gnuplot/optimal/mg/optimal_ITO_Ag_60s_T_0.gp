...
set output '../../../../img/optimal/mg/optimal_ITO_Ag_60s_T_0.png'
set title 'MG fit ITO_Ag_60s_T_0: effe=0.86626, d=11.45 nm, SSE=0.0027817'
...
plot \
  ...
  '../../../../data/output/optimal/mg/optimal_ITO_Ag_60s_T_0.dat' using 1:3 with lines lw 2 title 'mg best fit'
