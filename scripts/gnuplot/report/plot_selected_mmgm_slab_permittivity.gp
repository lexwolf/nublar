...
set output '../../../img/report/selected_mmgm_slab_permittivity.png'
set datafile commentschars '#'
set grid
set xlabel 'Wavelength (nm)'
set xrange [300:800]
set key outside right top
set multiplot layout 2,1 title 'Selected MMGM nanoisland slab permittivity'
set title 'Re epsilon_eff(lambda)'
...
plot '../../../data/output/report/permittivity/eps_slab_10s.dat' using 1:2 with lines lw 2 lc rgb '#1b9e77' title '10s', \
     ...
     '../../../data/output/report/permittivity/eps_slab_30s.dat' using 1:2 with lines lw 2 lc rgb '#d95f02' title '30s', \
     '../../../data/output/report/permittivity/eps_slab_40s.dat' using 1:2 with lines lw 2 lc rgb '#e6ab02' title '40s', \
     '../../../data/output/report/permittivity/eps_slab_50s.dat' using 1:2 with lines lw 2 lc rgb '#7570b3' title '50s', \
     '../../../data/output/report/permittivity/eps_slab_60s.dat' using 1:2 with lines lw 2 lc rgb '#e7298a' title '60s'
set title 'Im epsilon_eff(lambda)'
...
plot '../../../data/output/report/permittivity/eps_slab_10s.dat' using 1:3 with lines lw 2 lc rgb '#1b9e77' title '10s', \
     ...
     '../../../data/output/report/permittivity/eps_slab_30s.dat' using 1:3 with lines lw 2 lc rgb '#d95f02' title '30s', \
     '../../../data/output/report/permittivity/eps_slab_40s.dat' using 1:3 with lines lw 2 lc rgb '#e6ab02' title '40s', \
     '../../../data/output/report/permittivity/eps_slab_50s.dat' using 1:3 with lines lw 2 lc rgb '#7570b3' title '50s', \
