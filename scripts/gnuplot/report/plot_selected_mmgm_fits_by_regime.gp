...
set output '../../../img/report/selected_mmgm_fits_by_regime.png'
...
plot '../../../data/output/report/selected_runs/experimental_ITO_Ag_30s_T_0.dat' using 1:3 with points pointtype 7 pointsize 0.45 lc rgb '#d95f02' title '30s exp', \
...
set title 'late'
plot '../../../data/output/report/selected_runs/experimental_ITO_Ag_50s_T_0.dat' using 1:3 with points pointtype 7 pointsize 0.45 lc rgb '#7570b3' title '50s exp', \
