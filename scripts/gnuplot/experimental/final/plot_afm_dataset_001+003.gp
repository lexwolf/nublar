...
plot "data/experimental/final/afm_dataset_001+003.dat" using 1:3:4 title "coverage"

set ylabel "Equivalent thickness (nm)"
plot "data/experimental/final/afm_dataset_001+003.dat" using 1:5:6 title "thickness"

set ylabel "Mean equivalent radius (nm)"
plot "data/experimental/final/afm_dataset_001+003.dat" using 1:7:8 title "mean radius"

set ylabel "Number density (1/um^2)"
plot "data/experimental/final/afm_dataset_001+003.dat" using 1:11:12 title "density"
