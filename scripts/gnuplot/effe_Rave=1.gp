...
plot[300:900] "data/output/Rave=1.00__f=0.100.dat" w l lw 2 t "f = 0.1",  "data/output/Rave=1.00__f=0.200.dat" w l lw 2 t "f = 0.2",  "data/output/Rave=1.00__f=0.300.dat" w l lw 2 t "f = 0.3";
unset multiplot
unset output
