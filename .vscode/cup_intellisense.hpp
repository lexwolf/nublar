...
// IntelliSense-only fallback for extracted cup module headers when they are
// parsed standalone instead of through cup.hpp.
#if defined(__INTELLISENSE__) && \
    !defined(CUP_H) && \
    !defined(CUP_BACKEND_QUASI_STATIC) && \
    !defined(CUP_BACKEND_MIE)

#define CUP_H

#include "../extern/nano_geo_matrix/modules/cup/config.hpp"
